...
///
/// \param placeholderImage The image to be set initially until the image request finished. If <code>nil
/// </code>, the
/// image will not change its image until the image request finishes. <code>nil
/// </code> by default.
- (void)af_setImageForState:(UIControlState)state URL:(NSURL * __nonnull)URL placeHolderImage:(UIImage * __nullable)placeHolderImage;
...
/// <code>nil
/// </code> by default.
- (void)af_setBackgroundImageForState:(UIControlState)state URL:(NSURL * __nonnull)URL placeHolderImage:(UIImage * __nullable)placeHolderImage;
...
- (UIImage * __nullable)af_imageWithAppliedCoreImageFilter:(NSString * __nonnull)filterName filterParameters:(NSDictionary<NSString *, id> * __nullable)filterParameters;
@end
...
+ (UIImage * __nullable)af_threadSafeImageWithData:(NSData * __nonnull)data;
...
/// </code> object, or <code>nil
/// </code> if the method failed.
+ (UIImage * __nullable)af_threadSafeImageWithData:(NSData * __nonnull)data scale:(CGFloat)scale;
@end
...
- (UIImage * __nonnull)af_imageWithRoundedCornerRadius:(CGFloat)radius divideRadiusByImageScale:(BOOL)divideRadiusByImageScale;

/// Returns a new version of the image rounded into a circle.
///
/// \returns  A new image object.
- (UIImage * __nonnull)af_imageRoundedIntoCircle;
@end
...
///
/// \returns  A new image object.
- (UIImage * __nonnull)af_imageScaledToSize:(CGSize)size;
...
///
/// \returns  A new image object.
- (UIImage * __nonnull)af_imageAspectScaledToFitSize:(CGSize)size;
...
///
/// \returns  A new image object.
- (UIImage * __nonnull)af_imageAspectScaledToFillSize:(CGSize)size;
@end
...
/// \param placeholderImage The image to be set initially until the image request finished. If <code>nil
/// </code>, the
/// image view will not change its image until the image request finishes. <code>nil
/// </code> by
/// default.
- (void)af_setImageWithURL:(NSURL * __nonnull)URL placeholderImage:(UIImage * __nullable)placeholderImage;
